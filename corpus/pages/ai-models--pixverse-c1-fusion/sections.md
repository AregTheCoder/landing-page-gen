# PixVerse AI Video Model (C1 & V6) | Cinematic AI Video | Picsart

<https://picsart.com/ai-models/pixverse-c1-fusion/>
...
What you can create with PixVerse
[button: Cinematic videos from text]
...
### Explore more models like PixVerse
Compare PixVerse with other video models for cinematic motion, ads, and social clips.
...
### PixVerse AI model FAQ
#### What is PixVerse?
PixVerse is a cinematic AI video model available in Picsart in two versions - C1 and V6. It generates video from text, images, reference frames, or storyboards, with cinematic camera control and synchronized native audio, up to 15 seconds at 1080p.
#### What's the difference between PixVerse C1 and V6?
#### How can I use PixVerse?
#### What resolutions and lengths does PixVerse support?
#### Does PixVerse generate audio?
#### Which PixVerse version should I use?
...
Generate cinematic AI video with PixVerse
[button: Monthly]
...
PixVerse V6 PixVerse C1 PixVerse V6 Fusion PixVerse V6 Image PixVerse C1 Fusion PixVerse C1 Image Veo 3.1 Kling 3.0 Runway Gen 4 Luma Ray 2 WAN 2.7 Seedance 2.0 Sora 2 Luma Ray 3.2
