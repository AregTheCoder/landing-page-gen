...
uv run lp-corpus fetch https://picsart.com/ai-image-generator/
uv run lp-corpus sectionize ai-image-generator
uv run lp-corpus skeleton ai-image-generator --out runs/<run>/skeleton.md
